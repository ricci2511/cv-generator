...
const getFormEducations = (educationSections, deleteEducation, changeEducation, changeDate) => {
...
const getFormExperiences = (experienceSections, deleteExperience, changeExperience, changeDate) => {
